...
public class clothesLongPantsGreenScript : MonoBehaviour
{
    ...
    public void clothesLongPantsGreenClicked()
    {
        ...
        clothesLongPantsGreen.gameObject.SetActive(!clothesLongPantsGreen.gameObject.activeSelf);
    }
}
