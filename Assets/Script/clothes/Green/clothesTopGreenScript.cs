...
public class clothesTopGreenScript : MonoBehaviour
{
    ...
    public void clothesTopGreenClicked()
    {
        ...
        clothesTopGreen.gameObject.SetActive(!clothesTopGreen.gameObject.activeSelf);
    }
}
