...
public class clothesSkirtGreenScript : MonoBehaviour
{
    ...
    public void clothesSkirtGreenClicked()
    {
        ...
        clothesSkirtGreen.gameObject.SetActive(!clothesSkirtGreen.gameObject.activeSelf);
    }
}
