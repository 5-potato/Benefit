...
public class clothesPantsGreenScript : MonoBehaviour
{
    ...
    public void clothesPantsGreenClicked()
    {
        ...
        clothesPantsGreen.gameObject.SetActive(!clothesPantsGreen.gameObject.activeSelf);
    }
}
