...
public class clothesLongSkirtGreenScript : MonoBehaviour
{
    ...
    public void clothesLongSkirtGreenClicked()
    {
        ...
        clothesLongSkirtGreen.gameObject.SetActive(!clothesLongSkirtGreen.gameObject.activeSelf);
    }
}
