...
public class clothesLongGreenScript : MonoBehaviour
{
    ...
    public void clothesLongGreenClicked()
    {
        ...
        clothesLongGreen.gameObject.SetActive(!clothesLongGreen.gameObject.activeSelf);
    }
}
