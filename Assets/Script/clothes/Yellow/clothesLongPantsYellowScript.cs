...
public class clothesLongPantsYellowScript : MonoBehaviour
{
    ...
    public void clothesLongPantsYellowClicked()
    {
        ...
        clothesLongPantsYellow.gameObject.SetActive(!clothesLongPantsYellow.gameObject.activeSelf);
    }
}
