...
public class clothesLongSkirtYellowScript : MonoBehaviour
{
    ...
    public void clothesLongSkirtYellowClicked()
    {
        ...
        clothesLongSkirtYellow.gameObject.SetActive(!clothesLongSkirtYellow.gameObject.activeSelf);
    }
}
