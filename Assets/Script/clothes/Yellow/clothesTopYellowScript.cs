...
public class clothesTopYellowScript : MonoBehaviour
{
    ...
    public void clothesTopYellowClicked()
    {
        ...
        clothesTopYellow.gameObject.SetActive(!clothesTopYellow.gameObject.activeSelf);
    }
}
