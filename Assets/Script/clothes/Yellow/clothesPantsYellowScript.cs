...
public class clothesPantsYellowScript : MonoBehaviour
{
    ...
    public void clothesPantsYellowClicked()
    {
        ...
        clothesPantsYellow.gameObject.SetActive(!clothesPantsYellow.gameObject.activeSelf);
    }
}
