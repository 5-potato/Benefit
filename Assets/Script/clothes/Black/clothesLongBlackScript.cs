...
public class clothesLongBlackScript : MonoBehaviour
{
    ...
    public void clothesLongBlackClicked()
    {
        ...
        clothesLongBlack.gameObject.SetActive(!clothesLongBlack.gameObject.activeSelf);
    }
}
