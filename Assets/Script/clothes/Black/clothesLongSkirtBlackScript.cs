...
public class clothesLongSkirtBlackScript : MonoBehaviour
{
    ...
    public void clothesLongSkirtBlackClicked()
    {
        ...
        clothesLongSkirtBlack.gameObject.SetActive(!clothesLongSkirtBlack.gameObject.activeSelf);
    }
}
