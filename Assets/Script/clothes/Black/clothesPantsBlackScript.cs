...
public class clothesPantsBlackScript : MonoBehaviour
{
    ...
    public void clothesPantsBlackClicked()
    {
        ...
        clothesPantsBlack.gameObject.SetActive(!clothesPantsBlack.gameObject.activeSelf);
    }
}
