...
public class clothesTopBlackScript : MonoBehaviour
{
    ...
    public void clothesTopBlackClicked()
    {
        ...
        clothesTopBlack.gameObject.SetActive(!clothesTopBlack.gameObject.activeSelf);
    }
}
