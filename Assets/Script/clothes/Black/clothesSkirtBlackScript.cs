...
public class clothesSkirtBlackScript : MonoBehaviour
{
    ...
    public void clothesSkirtBlackClicked()
    {
        ...
        clothesSkirtBlack.gameObject.SetActive(!clothesSkirtBlack.gameObject.activeSelf);
    }
}
