...
public class clothesSleeveBlackScript : MonoBehaviour
{
    ...
    public void clothesSleevelessBlackClicked()
    {
        ...
        clothesSleevelessBlack.gameObject.SetActive(!clothesSleevelessBlack.gameObject.activeSelf);
    }
}
