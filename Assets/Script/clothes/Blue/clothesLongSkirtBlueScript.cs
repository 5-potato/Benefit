...
public class clothesLongSkirtBlueScript : MonoBehaviour
{
    ...
    public void clothesLongSkirtBlueClicked()
    {
        ...
        clothesLongSkirtBlue.gameObject.SetActive(!clothesLongSkirtBlue.gameObject.activeSelf);
    }
}
