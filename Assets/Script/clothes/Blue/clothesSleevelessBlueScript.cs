...
public class clothesSleevelessBlueScript : MonoBehaviour
{
    ...
    public void clothesSleevelessBlueClicked()
    {
        ...
        clothesSleevelessBlue.gameObject.SetActive(!clothesSleevelessBlue.gameObject.activeSelf);
    }
}
