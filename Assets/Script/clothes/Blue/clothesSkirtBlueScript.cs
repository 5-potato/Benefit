...
public class clothesSkirtBlueScript : MonoBehaviour
{
    ...
    public void clothesSkirtBlueClicked()
    {
        ...
        clothesSkirtBlue.gameObject.SetActive(!clothesSkirtBlue.gameObject.activeSelf);
    }
}
