...
public class clothesPantsBlueScript : MonoBehaviour
{
    ...
    public void clothesPantsBlueClicked()
    {
        ...
        clothesPantsBlue.gameObject.SetActive(!clothesPantsBlue.gameObject.activeSelf);
    }
}
