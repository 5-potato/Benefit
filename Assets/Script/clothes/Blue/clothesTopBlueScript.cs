...
public class clothesTopBlueScript : MonoBehaviour
{
    ...
    public void clothesTopBlueClicked()
    {
        ...
        clothesTopBlue.gameObject.SetActive(!clothesTopBlue.gameObject.activeSelf);
    }
}
