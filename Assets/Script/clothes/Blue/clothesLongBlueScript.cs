...
public class clothesLongBlueScript : MonoBehaviour
{
    ...
    public void clothesLongBlueClicked()
    {
        ...
        clothesLongBlue.gameObject.SetActive(!clothesLongBlue.gameObject.activeSelf);
    }
}
