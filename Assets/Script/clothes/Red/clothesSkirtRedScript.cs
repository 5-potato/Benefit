...
public class clothesSkirtRedScript : MonoBehaviour
{
    ...
    public void clothesSkirtRedClicked()
    {
        ...
        clothesSkirtRed.gameObject.SetActive(!clothesSkirtRed.gameObject.activeSelf);
    }
}
