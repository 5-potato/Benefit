...
public class clothesSleevelessRedScript : MonoBehaviour
{
    ...
    public void clothesSleevelessRedClicked()
    {
        ...
        clothesSleevelessRed.gameObject.SetActive(!clothesSleevelessRed.gameObject.activeSelf);
    }
}
