...
public class clothesPantsRedScript : MonoBehaviour
{
    ...
    public void clothesPantsRedClicked()
    {
        ...
        clothesPantsRed.gameObject.SetActive(!clothesPantsRed.gameObject.activeSelf);
    }
}
