...
public class clothesLongRedScript : MonoBehaviour
{
    ...
    public void clothesLongRedClicked()
    {
        ...
        clothesLongRed.gameObject.SetActive(!clothesLongRed.gameObject.activeSelf);
    }
}
