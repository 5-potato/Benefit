...
public class clothesLongPantsRedScript : MonoBehaviour
{
    ...
    public void clothesLongPantsRedClicked()
    {
        ...
        clothesLongPantsRed.gameObject.SetActive(!clothesLongPantsRed.gameObject.activeSelf);
    }
}
