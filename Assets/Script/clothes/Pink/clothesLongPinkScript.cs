...
public class clothesLongPinkScript : MonoBehaviour
{
    ...
    public void clothesLongPinkClicked()
    {
        ...
        clothesLongPink.gameObject.SetActive(!clothesLongPink.gameObject.activeSelf);
    }
}
