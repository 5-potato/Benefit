...
public class clothesTopPinkScript : MonoBehaviour
{
    ...
    public void clothesTopPinkClicked()
    {
        ...
        clothesTopPink.gameObject.SetActive(!clothesTopPink.gameObject.activeSelf);
    }
}
