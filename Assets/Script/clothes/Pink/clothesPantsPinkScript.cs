...
public class clothesPantsPinkScript : MonoBehaviour
{
    ...
    public void clothesPantsPinkClicked()
    {
        ...
        clothesPantsPink.gameObject.SetActive(!clothesPantsPink.gameObject.activeSelf);
    }
}
