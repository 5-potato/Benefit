...
public class clothesLongPantsPinkScript : MonoBehaviour
{
    ...
    public RawImage clotheaHansungOut2;
    public RawImage clotheaHansungPants;
    ...
    public void clothesLongPantsPinkClicked()
    {
        ...
        //한성
        if (clotheaHansungPants != null)
        {
            clotheaHansungPants.gameObject.SetActive(false);
        }
        if (clotheaHansungOut2 != null)
        {
            clotheaHansungOut2.gameObject.SetActive(false);
        }

        clothesLongPantsPink.gameObject.SetActive(!clothesLongPantsPink.gameObject.activeSelf);
    }
}
