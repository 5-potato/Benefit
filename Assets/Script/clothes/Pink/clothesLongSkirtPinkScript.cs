...
public class clothesLongSkirtPinkScript : MonoBehaviour
{
    ...
    public void clothesLongSkirtPinkClicked()
    {
        ...
        clothesLongSkirtPink.gameObject.SetActive(!clothesLongSkirtPink.gameObject.activeSelf);
    }
}
