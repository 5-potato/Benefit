...
public class clothesSkirtPinkScript : MonoBehaviour
{
    ...
    public void clothesSkirtPinkClicked()
    {
        ...
        clothesSkirtPink.gameObject.SetActive(!clothesSkirtPink.gameObject.activeSelf);
    }
}
