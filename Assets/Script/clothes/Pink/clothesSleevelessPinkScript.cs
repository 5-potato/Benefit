...
public class clothesSleevelessPinkScript : MonoBehaviour
{
    ...
    public void clothesSleevelessPinkClicked()
    {
        ...
        clothesSleevelessPink.gameObject.SetActive(!clothesSleevelessPink.gameObject.activeSelf);
    }
}
