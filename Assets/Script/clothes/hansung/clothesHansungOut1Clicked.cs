...
public class clothesHansungOut1Clicked : MonoBehaviour
{
    ...
    public void HansungOut1isClicked()
    {
        ...
        clothesHansungOut1.gameObject.SetActive(!clothesHansungOut1.gameObject.activeSelf);
    }
}
