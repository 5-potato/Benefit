...
public class clothesHansungOut2Clicked : MonoBehaviour
{
    ...
    public void clothesHansungOut2isClicked()
    {
        ...
        clothesHansungOut2.gameObject.SetActive(!clothesHansungOut2.gameObject.activeSelf);
    }
}
