...
public class clothesHansungTopBlackClicked: MonoBehaviour
{
    ...
    public void HansungTopBlackisClicked()
    {
        ...
        clothesHansungTopBlack.gameObject.SetActive(!clothesHansungTopBlack.gameObject.activeSelf);
    }
}
