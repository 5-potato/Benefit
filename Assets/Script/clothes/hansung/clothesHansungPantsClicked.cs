...
public class clothesHansungPantsClicked : MonoBehaviour
{
    ...
    public void clothesHansungPantsisClicked()
    {
        ...
        clothesHansungPants.gameObject.SetActive(!clothesHansungPants.gameObject.activeSelf);
    }
}
