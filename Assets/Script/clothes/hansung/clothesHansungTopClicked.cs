...
public class clothesHansungTopClicked : MonoBehaviour
{
    ...
    public void HSUTopClicked()
    {
        ...
        clothesHansungTop.gameObject.SetActive(!clothesHansungTop.gameObject.activeSelf);
    }
}
