...
public class clothesPantsPurpleScript : MonoBehaviour
{
    ...
    public void clothesPantsPurpleClicked()
    {
        ...
        clothesPantsPurple.gameObject.SetActive(!clothesPantsPurple.gameObject.activeSelf);
    }
}
