...
public class clothesSleevePurpleScript : MonoBehaviour
{
    ...
    public void clothesSleevelessPurpleClicked()
    {
        ...
        clothesSleevelessPurple.gameObject.SetActive(!clothesSleevelessPurple.gameObject.activeSelf);
    }
}
