...
public class clothesLongPurpleScript : MonoBehaviour
{
    ...
    public void clothesLongPurpleClicked()
    {
        ...
        clothesLongPurple.gameObject.SetActive(!clothesLongPurple.gameObject.activeSelf);
    }
}
