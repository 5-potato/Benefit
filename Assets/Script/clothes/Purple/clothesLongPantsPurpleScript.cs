...
public class clothesLongPantsPurpleScript : MonoBehaviour
{
    ...
    public void clothesLongPantsPurpleClicked()
    {
        ...
        clothesLongPantsPurple.gameObject.SetActive(!clothesLongPantsPurple.gameObject.activeSelf);
    }
}
