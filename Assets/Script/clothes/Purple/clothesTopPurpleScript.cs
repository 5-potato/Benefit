...
public class clothesTopPurpleScript : MonoBehaviour
{
    ...
    public void clothesTopPurpleClicked()
    {
        ...
        clothesTopPurple.gameObject.SetActive(!clothesTopPurple.gameObject.activeSelf);
    }
}
