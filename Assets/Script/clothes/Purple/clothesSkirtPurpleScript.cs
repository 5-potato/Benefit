...
public class clothesSkirtPurpleScript : MonoBehaviour
{
    ...
    public void clothesSkirtPurpleClicked()
    {
        ...
        clothesSkirtPurple.gameObject.SetActive(!clothesSkirtPurple.gameObject.activeSelf);
    }
}
