...
public class clothesLongSkirtPurpleScript : MonoBehaviour
{
    ...
    public void clothesLongSkirtPurpleClicked()
    {
        ...
        clothesLongSkirtPurple.gameObject.SetActive(!clothesLongSkirtPurple.gameObject.activeSelf);
    }
}
