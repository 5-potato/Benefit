...
public class noneScript : MonoBehaviour
{
    ...
    public RawImage hansungTop;
    public RawImage hansungTopBlack;
    public RawImage hansungOut;
    public RawImage hansungOut2;
    public RawImage hansungPants;
    ...
    public void noneClicked()
    {
        ...
        if (clothesLongSkirtBlue != null)
        {
            clothesLongSkirtBlue.gameObject.SetActive(false);
        }

        if (clothesSkirtBlue != null)
        {
            clothesSkirtBlue.gameObject.SetActive(false);
        }

        if (clothesLongPantsBlue != null)
        {
            clothesLongPantsBlue.gameObject.SetActive(false);
        }

        if (clothesPantsBlue != null)
        {
            clothesPantsBlue.gameObject.SetActive(false);
        }
        ...
        if (hansungTop != null)
        {
            hansungTop.gameObject.SetActive(false);
        }
        if (hansungTopBlack != null)
        {
            hansungTopBlack.gameObject.SetActive(false);
        }
        if (hansungOut != null)
        {
            hansungOut.gameObject.SetActive(false);
        }
        if (hansungOut2 != null)
        {
            hansungOut2.gameObject.SetActive(false);
        }
        if (hansungPants != null)
        {
            hansungPants.gameObject.SetActive(false);
        }
    }
}
