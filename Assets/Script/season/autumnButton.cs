...
public class autumnButton : MonoBehaviour
{
    // Start is called before the first frame update
    public Button autumn;
    ...
    {
        // 버튼 클릭 이벤트에 메서드 연결
        autumn.onClick.AddListener(OnClickAutumnButtons);
    }

    void OnClickAutumnButtons()
    {
        ...
        if(pinkclothes3.gameObject.activeSelf){
