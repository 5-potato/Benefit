...
public class winterButton : MonoBehaviour
{
    ...
    {
        // 버튼 클릭 이벤트에 메서드 연결
        winter.onClick.AddListener(OnClickWinterButtons);
    }

    void OnClickWinterButtons()
    {
        
        if(redclothes2.gameObject.activeSelf||redclothes4.gameObject.activeSelf||redclothes6.gameObject.activeSelf||redclothes5.gameObject.activeSelf||redclothes7.gameObject.activeSelf) {
        ...
        if(pinkclothes2.gameObject.activeSelf||pinkclothes4.gameObject.activeSelf||pinkclothes6.gameObject.activeSelf||pinkclothes5.gameObject.activeSelf||pinkclothes7.gameObject.activeSelf) {
        ...
        if(yellowclothes2.gameObject.activeSelf||yellowclothes4.gameObject.activeSelf||yellowclothes6.gameObject.activeSelf||yellowclothes5.gameObject.activeSelf||yellowclothes7.gameObject.activeSelf){
        ...
        if(greenclothes2.gameObject.activeSelf||greenclothes4.gameObject.activeSelf||greenclothes6.gameObject.activeSelf||greenclothes5.gameObject.activeSelf||greenclothes7.gameObject.activeSelf){ 
        ...
        if(blueclothes2.gameObject.activeSelf||blueclothes4.gameObject.activeSelf||blueclothes6.gameObject.activeSelf||blueclothes5.gameObject.activeSelf||blueclothes7.gameObject.activeSelf){
        ...
        if(purpleclothes2.gameObject.activeSelf||purpleclothes4.gameObject.activeSelf||purpleclothes6.gameObject.activeSelf||purpleclothes5.gameObject.gameObject.activeSelf||purpleclothes7.gameObject.activeSelf){
        ...
        if(blackclothes2.gameObject.activeSelf||blackclothes4.gameObject.activeSelf||blackclothes6.gameObject.activeSelf||blackclothes5.gameObject.activeSelf||blackclothes7.gameObject.activeSelf){
