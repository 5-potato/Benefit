...
public class summerButton : MonoBehaviour
{
    ...
    public Button summer;


    
    void Start()
    {
        summer.onClick.AddListener(onClickedSummerButton);
    }
    void onClickedSummerButton()
    {
        

        if(redclothes1.gameObject.activeSelf || redclothes7.gameObject.activeSelf || redclothes6.gameObject.activeSelf){
        ...
        if(pinkclothes1.gameObject.activeSelf||pinkclothes7.gameObject.activeSelf||pinkclothes6.gameObject.activeSelf){
        ...
        if(yellowclothes1.gameObject.activeSelf||yellowclothes7.gameObject.activeSelf||yellowclothes6.gameObject.activeSelf){
        ...
        if(greenclothes1.gameObject.activeSelf||greenclothes7.gameObject.activeSelf||greenclothes6.gameObject.activeSelf){
        ...
        if(blueclothes1.gameObject.activeSelf||blueclothes7.gameObject.activeSelf||blueclothes6.gameObject.activeSelf){
        ...
        if(purpleclothes1.gameObject.activeSelf||purpleclothes7.gameObject.activeSelf||purpleclothes6.gameObject.activeSelf){
        ...
        if(blackclothes1.gameObject.activeSelf||blackclothes7.gameObject.activeSelf||blackclothes6.gameObject.activeSelf){
