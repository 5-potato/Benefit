...
public class springButton : MonoBehaviour
{
    ...
    void Start()
    {
        spring.onClick.AddListener(onClickedSpringButton);
    }
    void onClickedSpringButton(){
        redclothes1.gameObject.SetActive(false);
        redclothes2.gameObject.SetActive(false);
        if(redclothes3.gameObject.activeSelf||redclothes6.gameObject.activeSelf||redclothes7.gameObject.activeSelf) {
        ...
        if(pinkclothes3.gameObject.activeSelf||pinkclothes6.gameObject.activeSelf||pinkclothes7.gameObject.activeSelf){
        ...
        if(yellowclothes3.gameObject.activeSelf||yellowclothes6.gameObject.activeSelf||yellowclothes7.gameObject.activeSelf){
        ...
        if(greenclothes3.gameObject.activeSelf||greenclothes6.gameObject.activeSelf||greenclothes7.gameObject.activeSelf){
        ...
        if(blueclothes3.gameObject.activeSelf||blueclothes6.gameObject.activeSelf||blueclothes7.gameObject.activeSelf){
        ...
        if(purpleclothes3.gameObject.activeSelf||purpleclothes6.gameObject.activeSelf||purpleclothes7.gameObject.activeSelf){
        ...
        if(blackclothes3.gameObject.activeSelf||blackclothes6.gameObject.activeSelf||blackclothes7.gameObject.activeSelf){
